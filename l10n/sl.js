OC.L10N.register(
    ...
    {
    "Downloaded by {actor} (via desktop)" : "{actor} prejme predmet (po namiznem odjemalcu)",
    "Downloaded by {actor} (via app)" : "{actor} prejme predmet (s prenosno napravo)",
    "Downloaded by {actor} (via browser)" : "{actor} prejme predmet (s spletnega brskalnika)",
