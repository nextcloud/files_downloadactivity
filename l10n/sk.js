OC.L10N.register(
    ...
    "Downloaded by {actor} (via browser)" : "Stiahunté používateľom {actor} (pomocou prehliadača)",
    "Shared file {file} was downloaded by {actor} via the desktop client" : "Sprístupnený súbor {file} bol stiahnutý používateľom {actor} pomocou PC klienta",
