OC.L10N.register(
    ...
    {
    "Downloaded by {actor} (via desktop)" : "{actor} відкрив(-ла) файл на комп'ютері",
    ...
    "Shared file {file} was downloaded by {actor} via the desktop client" : "{actor} звантажив(-ла) файл у спільному доступі {file} за допомогою настільного клієнта",
    "Shared file {file} was downloaded by {actor} via the mobile app" : "{actor} звантажив(-ла) файл у спільному доступі {file} у мобільному застосунку",
    "Shared file {file} was downloaded by {actor} via the browser" : "{actor} звантажив(-ла) спільний файл {file} у бравзері",
