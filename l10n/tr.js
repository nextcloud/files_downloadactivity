OC.L10N.register(
    ...
    {
    "Downloaded by {actor} (via desktop)" : "{actor} tarafından indirildi (bilgisayar ile)",
    "Downloaded by {actor} (via app)" : "{actor} tarafından indirildi (uygulama ile)",
    "Downloaded by {actor} (via browser)" : "{actor} tarafından indirildi (tarayıcı ile)",
    "Shared file {file} was downloaded by {actor} via the desktop client" : "Paylaşılan {file} dosyası {actor} tarafından bilgisayar istemcisi ile indirildi",
