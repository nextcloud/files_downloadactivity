OC.L10N.register(
    ...
    {
    "Downloaded by {actor} (via desktop)" : "Téléchargé par {actor} (via le client de bureau)",
    "Downloaded by {actor} (via app)" : "Téléchargé par {actor} (via l'application mobile)",
    "Downloaded by {actor} (via browser)" : "Téléchargé par {actor} (via le navigateur)",
    "Shared file {file} was downloaded by {actor} via the desktop client" : "Le fichier partagé {file} a été téléchargé par {actor} via le client de bureau",
    ...
    "A local shared file or folder was <strong>downloaded</strong>" : "Un fichier ou un dossier local partagé a été <strong>téléchargé</strong>",
    "Sharing" : "Partage",
